...
GOOGLE_REDIRECT_URI="https://afromarket-staging.preview.emergentagent.com/api/auth/google/callback"
```
...
6. Add authorized redirect URI: `https://afromarket-staging.preview.emergentagent.com/api/auth/google/callback`
